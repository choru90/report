package net.huray.project.common.filter;
...
//    logPayload("Response", response.getContentType(), response.getContentInputStream()); // fixme
    log.info("Response Payload: content size {}", response.getContentSize());
  }
  ...
  public static class ResponseWrapper extends ContentCachingResponseWrapper {
